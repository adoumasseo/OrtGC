                            ...
                            <tbody>
                                <?php $__currentLoopData = $departements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($item->users[0]->nom); ?> <?php echo e($item->users[0]->prenom); ?></td>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Hervé Carlos\Documents\econtrat\resources\views/departements/index.blade.php ENDPATH**/ ?>