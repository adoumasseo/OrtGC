                        ...
                        <tbody>
                            <?php $__currentLoopData = $class; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($item->filiere->departement->nom); ?></td>
                                    <td><?php echo e($item->filiere->nom); ?></td>
                                    <td><?php echo e($item->nom); ?></td>
                                    <td><?php echo e($item->effectif); ?></td>
                                    <td><?php echo e($item->niveau); ?></td>
                                    <td><?php echo e($item->cycle->nom); ?></td>
                                    <td>
                                        <div class="d-flex">
                                            <a href="<?php echo e(route('classes.show', ['class' => $item->slug])); ?>"
                                            ...
                                            <?php if(Auth::user()->hasRole('Concepteur') or Auth::user()->hasRole('Administrateur')): ?>
                                                <a href="<?php echo e(route('classes.edit', ['class' => $item->slug])); ?>"
                                                    type="button" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                    title="Editer"
