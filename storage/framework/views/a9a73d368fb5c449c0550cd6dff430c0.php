...
<?php $__env->startSection('content'); ?>
    ...
    <div class="border card rounded-0">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('ecues.store')); ?>" method="post">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('ue_id')); ?>" id="basiInput">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\econtrat\resources\views/ecues/create.blade.php ENDPATH**/ ?>