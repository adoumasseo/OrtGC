...
<?php $__env->startSection('content'); ?>
    <div class="card rounded-0 ">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('universites.update', ['universite' => $universite->slug])); ?>" method="post">
...
unset($__errorArgs, $__bag); ?>" name="code"
                            value="<?php echo e($universite->code); ?>" id="basiInput">
...
unset($__errorArgs, $__bag); ?>" name="nom"
                            value="<?php echo e($universite->nom); ?>" id="basiInput">
                        <?php $__errorArgs = ['nom'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" name="email"
                            value="<?php echo e($universite->email); ?>" id="emailInput">
...
unset($__errorArgs, $__bag); ?>" name="recteur"
                            value="<?php echo e(old('recteur', $universite->recteur)); ?>" id="recteurInput">
...
unset($__errorArgs, $__bag); ?>" name="comptable"
                            value="<?php echo e($universite->comptable); ?>" id="comptableInput">
...
unset($__errorArgs, $__bag); ?>" name="siteweb"
                            value="<?php echo e($universite->siteweb); ?>" id="sitewebInput">
...
unset($__errorArgs, $__bag); ?>" name="telephone"
                            value="<?php echo e($universite->telephone); ?>" id="telephoneInput">
...
unset($__errorArgs, $__bag); ?>" name="ville"
                            value="<?php echo e($universite->ville); ?>" id="villeInput">
...
unset($__errorArgs, $__bag); ?>" name="adresse"
                            value="<?php echo e($universite->adresse); ?>" id="adresseInput">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Documents\workflow\challenges\econtrat\resources\views/universites/edit.blade.php ENDPATH**/ ?>