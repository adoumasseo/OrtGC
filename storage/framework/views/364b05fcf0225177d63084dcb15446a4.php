        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <a href="<?php echo e(route('universites.create')); ?>">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $universites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($item->recteur); ?></td>
                                        <td>
                                            <div class="d-flex">
                                                <a href="<?php echo e(route('universites.show', ['universite' => $item->slug])); ?>"
                                                ...
                                                <?php if(Auth::user()->hasRole('Concepteur') or Auth::user()->hasRole('Administrateur')): ?>
                                                    <a href="<?php echo e(route('universites.edit', ['universite' => $item->slug])); ?>"
                                                        type="button" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                        title="Editer"
                                                    ...
                                                    <button type="button" data-universite="<?php echo e($item->slug); ?>"
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(URL::asset('assets/js/pages/customs/universite.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('/assets/js/app.min.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Documents\workflow\challenges\econtrat\resources\views/universites/index.blade.php ENDPATH**/ ?>