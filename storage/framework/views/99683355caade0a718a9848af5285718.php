...
<?php $__env->startSection('content'); ?>
    <div class="profile-foreground position-relative mx-n4 mt-n4">
        <div class="profile-wid-bg">
            <img src="<?php echo e($universite->imageUrl()); ?>" alt="" class="profile-wid-img" />
        </div>
    </div>
    <div class="pt-4 mb-4 mb-lg-3 pb-lg-4 profile-wrapper">
        <div class="row g-4">
            <div class="col-auto">
                <div class="avatar-lg">
                    <img src="<?php echo e($universite->imageUrl()); ?>"
            ...
            <div class="col">
                <div class="p-2">
                    <h3 class="text-white mb-1"><?php echo e($universite->nom); ?></h3>
                    <p class="text-white text-opacity-75"><?php echo e($universite->recteur); ?></p>
                    <div class="hstack text-white-50 gap-1">
                        <div class="me-2"><i
                                class="ri-map-pin-user-line me-1 text-white text-opacity-75 fs-16 align-middle"></i><?php echo e($universite->ville); ?>

                        </div>
                        <div><i
                                class="ri-building-line me-1 text-white text-opacity-75 fs-16 align-middle"></i><?php echo e($universite->adresse); ?>
            ...
            <div class="col-12 col-lg-auto order-last order-lg-0">
                <div class="row text text-white-50 text-center">
                    <div class="col-lg-6 col-4">
                        <div class="p-2">
                            <h4 class="text-white mb-1"><?php echo e(count($universite->ufrs)); ?></h4>
...
unset($__errorArgs, $__bag); ?>" name="code"
                        value="<?php echo e($universite->code); ?>" id="basiInput" readonly>
...
unset($__errorArgs, $__bag); ?>" name="nom"
                        value="<?php echo e($universite->nom); ?>" id="basiInput" readonly>
                    <?php $__errorArgs = ['nom'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3 col-md-6">
                    ...
                    <input type="text" class="form-control <?php $__errorArgs = ['recteur'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="recteur"
                        value="<?php echo e($universite->recteur); ?>" readonly id="recteurInput">
                    <?php $__errorArgs = ['recteur'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        <span class="text-danger"> <?php echo e($errors->first('recteur')); ?></span>
                    <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3 col-md-6">
                    ...
                    <input type="text" class="form-control <?php $__errorArgs = ['comptable'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                        name="comptable" value="<?php echo e($universite->comptable); ?>" readonly id="comptableInput">
                    <?php $__errorArgs = ['comptable'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        <span class="text-danger"> <?php echo e($errors->first('comptable')); ?></span>
                    <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
unset($__errorArgs, $__bag); ?>" name="email"
                        value="<?php echo e(old('email', $universite->email)); ?>" readonly id="emailInput">
...
unset($__errorArgs, $__bag); ?>" name="siteweb"
                        value="<?php echo e($universite->siteweb); ?>" readonly id="sitewebInput">
...
unset($__errorArgs, $__bag); ?>" name="phone"
                        value="<?php echo e($universite->telephone); ?>" readonly id="telephoneInput">
...
unset($__errorArgs, $__bag); ?>" name="ville"
                        value="<?php echo e($universite->ville); ?>" readonly id="villeInput">
...
unset($__errorArgs, $__bag); ?>" name="adresse"
                        value="<?php echo e($universite->adresse); ?>" readonly id="adresseInput">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="px-2 py-3 mt-3 bg-light d-flex justify-content-between">
                <a href="<?php echo e(route('universites.index')); ?>" type="button"
                    class="btn btn-info rounded-0 btn-label waves-effect waves-light"><i
                        class="align-middle ri-arrow-drop-left-line label-icon fs-16 me-2"></i> Annuler </a>

                <a href="<?php echo e(route('universites.edit', ['universite' => $universite->slug])); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Documents\workflow\challenges\econtrat\resources\views/universites/show.blade.php ENDPATH**/ ?>