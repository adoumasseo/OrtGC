...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card rounded-0 ">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('filieres.update', ['filiere' => $filiere->slug])); ?>" method="post">
...
unset($__errorArgs, $__bag); ?>" name="nom"
                            value="<?php echo e($filiere->nom); ?>" id="basiInput">
                        <?php $__errorArgs = ['nom'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        <span class="text-danger"> <?php echo e($errors->first('departement_id')); ?></span>
                    <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                ...
                <div class="px-2 py-3 mt-3 bg-light d-flex justify-content-between">
                    <a href="<?php echo e(route('filieres.index')); ?>" type="button"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\econtrat\resources\views/filieres/edit.blade.php ENDPATH**/ ?>