...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card rounded-0 ">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('cycles.update', ['cycle' => $cycle->slug])); ?>" method="post">
...
unset($__errorArgs, $__bag); ?>" name="nom"
                            value="<?php echo e($cycle->nom); ?>" id="basiInput">
                        <?php $__errorArgs = ['nom'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" name="montant"
                            value="<?php echo e($cycle->montant); ?>" id="basiInput">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tamuzo77/IdeaProjects/Laravel/econtrat/resources/views/cycles/edit.blade.php ENDPATH**/ ?>