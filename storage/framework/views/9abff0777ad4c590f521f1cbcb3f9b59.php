...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card rounded-0 ">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('ues.update', ['ue' => $ue->slug])); ?>" method="post">
...
unset($__errorArgs, $__bag); ?>" name="code"
                            value="<?php echo e($ue->code); ?>" id="basiInput">
...
unset($__errorArgs, $__bag); ?>" name="nom"
                            value="<?php echo e($ue->nom); ?>" id="basiInput">
                        <?php $__errorArgs = ['nom'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LEOCADIE CISSOKO\Documents\econtrat\resources\views/ues/edit.blade.php ENDPATH**/ ?>