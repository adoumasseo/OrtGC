...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card rounded-0 ">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('classes.update', ['class' => $class->slug])); ?>" method="post">
...
unset($__errorArgs, $__bag); ?>" name="nom"
                            value="<?php echo e($class->nom); ?>" id="basiInput">
                        <?php $__errorArgs = ['nom'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" name="effectif"
                            value="<?php echo e($class->effectif); ?>" id="basiInput">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3 col-md-12">
                        ...
                        <input type="text" class="form-control <?php $__errorArgs = ['niveau'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="niveau"
                            value="<?php echo e($class->niveau); ?>" id="basiInput">
                        <?php $__errorArgs = ['niveau'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            <span class="text-danger"> <?php echo e($errors->first('niveau')); ?></span>
                        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
unset($__errorArgs, $__bag); ?>" name="filiere_id" id="basiInput">
                            <?php $__currentLoopData = $filieres; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filiere): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($filiere->id); ?>" <?php echo e($class->filiere_id == $filiere->id ? 'selected' : ''); ?>><?php echo e($filiere->nom); ?></option>
...
unset($__errorArgs, $__bag); ?>" name="cycle_id" value="<?php echo e(old('cycle_id')); ?>" id="basiInput">
                            <?php $__currentLoopData = $cycles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cycle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($cycle->id); ?>" <?php echo e($class->cycle_id == $cycle->id ? 'selected' : ''); ?>><?php echo e($cycle->nom); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\Documents\econtrat\resources\views/classes/edit.blade.php ENDPATH**/ ?>