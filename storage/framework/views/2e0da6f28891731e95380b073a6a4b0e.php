...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="d-flex p-2">
                                        <div class="flex-shrink-0 me-3">
                                            <div class="avatar-sm bg-light rounded">
                                                <img data-dz-thumbnail class="img-fluid rounded d-block" src="<?php echo e($user->avatar); ?>"
                                                     alt=""/>
                                            </div>
                                        </div>
            ...
            <div class="px-2 py-3 mt-3 bg-light d-flex justify-content-between">
                ...
                <button disabled type="submit" class="btn btn-success rounded-0 btn-label waves-effect waves-light"><i
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tamuzo77/IdeaProjects/Laravel/econtrat/resources/views/users/edit.blade.php ENDPATH**/ ?>