...
<?php $__env->startSection('content'); ?>
    <div class="border card rounded-0">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('ufrs.store')); ?>" method="post" enctype="multipart/form-data" >
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="nom"
                            value="<?php echo e(old('nom')); ?>" id="nomInput">
                        <?php $__errorArgs = ['nom'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>">
                            <?php $__currentLoopData = $universites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>" name="adresse"
                            value="<?php echo e(old('adresse')); ?>" id="adresseInput">
...
unset($__errorArgs, $__bag); ?>" name="siteweb"
                            value="<?php echo e(old('siteweb')); ?>" id="siteInput">
...
unset($__errorArgs, $__bag); ?>" name="email"
                            value="<?php echo e(old('email')); ?>" id="emailInput">
...
unset($__errorArgs, $__bag); ?>" name="directeur"
                            value="<?php echo e(old('directeur')); ?>" id="directeurInput">
...
unset($__errorArgs, $__bag); ?>" name="ville"
                            value="<?php echo e(old('ville')); ?>" id="villeInput">
...
unset($__errorArgs, $__bag); ?>" name="logo"
                            value="<?php echo e(old('logo')); ?>" id="logoInput">
...
unset($__errorArgs, $__bag); ?>" name="telephone"
                            value="<?php echo e(old('telephone')); ?>" id="telInput">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/herve/Documents/econtrat/resources/views/ufrs/create.blade.php ENDPATH**/ ?>