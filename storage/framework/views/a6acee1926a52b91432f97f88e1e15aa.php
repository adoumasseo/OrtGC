            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="<?php echo e(URL::asset('images/logo-mesrs.png')); ?>" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="<?php echo e(URL::asset('images/logo-mesrs.png')); ?>" alt="" height="17">
                        </span>
                    </a>
                ...
                <form class="app-search d-none d-md-block">
                    <div class="mt-2">
                        <h4> <?php echo e(Auth::user()->ufr ? Auth::user()->ufr->nom : 'Administration e-contrat'); ?> </h4>
                    </div>
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle shadow-none"
                        ...
                        <?php switch(Session::get('lang')):
                            case ('ru'): ?>
                                <img src="<?php echo e(URL::asset('build/images/flags/russia.svg')); ?>" class="rounded "
                                     alt="Header Language" height="18">
                                <?php break; ?>
                            <?php case ('it'): ?>
                                <img src="<?php echo e(URL::asset('build/images/flags/italy.svg')); ?>" class="rounded "
                                     alt="Header Language" height="18">
                                <?php break; ?>
                            <?php case ('sp'): ?>
                                <img src="<?php echo e(URL::asset('build/images/flags/spain.svg')); ?>" class="rounded "
                                     alt="Header Language" height="18">
                                <?php break; ?>
                            <?php case ('ch'): ?>
                                <img src="<?php echo e(URL::asset('build/images/flags/china.svg')); ?>" class="rounded "
                                     alt="Header Language" height="18">
                                <?php break; ?>
                            <?php case ('fr'): ?>
                                <img src="<?php echo e(URL::asset('build/images/flags/french.svg')); ?>" class="rounded "
                                     alt="Header Language" height="18">
                                <?php break; ?>
                            <?php case ('gr'): ?>
                                <img src="<?php echo e(URL::asset('build/images/flags/germany.svg')); ?>" class="rounded "
                                     alt="Header Language" height="18">
                                <?php break; ?>
                            <?php case ('ae'): ?>
                                <img src="<?php echo e(URL::asset('build/images/flags/ae.svg')); ?>" class="rounded "
                                     alt="Header Language" height="18">
                                <?php break; ?>
                            <?php default: ?>
                                <img src="<?php echo e(URL::asset('build/images/flags/us.svg')); ?>" class="rounded "
                                     alt="Header Language" height="18">
                        <?php endswitch; ?>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a href="<?php echo e(url('index/en')); ?>" class="dropdown-item notify-item language py-2" data-lang="en"
                           title="English">
                            <img src="<?php echo e(URL::asset('build/images/flags/us.svg')); ?>" alt="user-image"
                        ...
                        <a href="<?php echo e(url('index/sp')); ?>" class="dropdown-item notify-item language" data-lang="sp"
                           title="Spanish">
                            <img src="<?php echo e(URL::asset('build/images/flags/spain.svg')); ?>" alt="user-image"
                                 class="me-2 rounded" height="18">
                        ...
                        <a href="<?php echo e(url('index/gr')); ?>" class="dropdown-item notify-item language" data-lang="gr"
                           title="German">
                            <img src="<?php echo e(URL::asset('build/images/flags/germany.svg')); ?>" alt="user-image"
                        ...
                        <a href="<?php echo e(url('index/it')); ?>" class="dropdown-item notify-item language" data-lang="it"
                           title="Italian">
                            <img src="<?php echo e(URL::asset('build/images/flags/italy.svg')); ?>" alt="user-image"
                                 class="me-2 rounded" height="18">
                        ...
                        <a href="<?php echo e(url('index/ru')); ?>" class="dropdown-item notify-item language" data-lang="ru"
                           title="Russian">
                            <img src="<?php echo e(URL::asset('build/images/flags/russia.svg')); ?>" alt="user-image"
                                 class="me-2 rounded" height="18">
                        ...
                        <a href="<?php echo e(url('index/fr')); ?>" class="dropdown-item notify-item language" data-lang="fr"
                           title="French">
                            <img src="<?php echo e(URL::asset('build/images/flags/french.svg')); ?>" alt="user-image"
                                 class="me-2 rounded" height="18">
                    ...
                    <div class="dropdown-menu dropdown-menu-xl dropdown-menu-end p-0 dropdown-menu-cart"
                        ...
                        <div data-simplebar style="max-height: 300px;">
                            <div class="p-2">
                                ...
                                <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('build/images/products/img-6.png')); ?>"
                                             class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                        <div class="flex-grow-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                    ...
                    <button type="button" class="btn shadow-none" id="page-header-user-dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            <img class="rounded-circle header-profile-user"
                                 src="<?php if(Auth::user()->avatar != ''): ?><?php echo e(URL::asset('images/' . Auth::user()->avatar)); ?><?php else: ?><?php echo e("https://ui-avatars.com/api/?name={$nom_complet}&background=random"); ?><?php endif; ?>"
                                 alt="Header Avatar">
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text"><?php echo e($nom_complet); ?></span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
...
<?php /**PATH /home/tamuzo77/IdeaProjects/Laravel/econtrat/resources/views/layouts/topbar.blade.php ENDPATH**/ ?>