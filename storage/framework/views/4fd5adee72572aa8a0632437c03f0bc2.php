...
<?php $__env->startSection('content'); ?>
    <div class="card rounded-0 ">
        <div class="card-header">
            <h2 class="card-title">
                <?php echo e($enseignant->nom . ' ' . $enseignant->prenoms); ?>

            </h2>
        </div>
        <div class="card-body">
            <form action="<?php echo e(route('enseignants.update', ['enseignant' => $enseignant->slug])); ?>" method="post">
...
unset($__errorArgs, $__bag); ?>" name="nom"
                            value="<?php echo e($enseignant->nom); ?>" id="basiInput">
                        <?php $__errorArgs = ['nom'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" name="prenoms"
                            value="<?php echo e($enseignant->prenoms); ?>" id="basiInput">
...
unset($__errorArgs, $__bag); ?>" name="email"
                            value="<?php echo e($enseignant->email); ?>" id="basiInput">
...
unset($__errorArgs, $__bag); ?>" name="telephone"
                            value="<?php echo e($enseignant->telephone); ?>" id="basiInput">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <select name="sexe" class="form-control" value="<?php echo e($enseignant->sexe); ?>" id="basiInput"
...
unset($__errorArgs, $__bag); ?>">
                            <option <?php echo e($enseignant->sexe == 'Masculin' ? 'selected' : ''); ?> value="Masculin">Masculin
                            </option>
                            <option <?php echo e($enseignant->sexe == 'Féminin' ? 'selected' : ''); ?> value="Féminin">Féminin</option>
                            <option <?php echo e($enseignant->sexe == 'Autre' ? 'selected' : ''); ?> value="Autre">Autre</option>
                        </select>
                        <?php $__errorArgs = ['sexe'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>"
                            name="profession" value="<?php echo e($enseignant->profession); ?>" id="basiInput">
...
unset($__errorArgs, $__bag); ?>" name="adresse"
                            value="<?php echo e($enseignant->adresse); ?>" id="basiInput">
...
unset($__errorArgs, $__bag); ?>"
                            name="nationalite" value="<?php echo e($enseignant->nationalite); ?>" id="basiInput">
...
unset($__errorArgs, $__bag); ?>"
                            name="date_naissance" value="<?php echo e($enseignant->date_naissance); ?>" id="basiInput">
...
unset($__errorArgs, $__bag); ?>" name="npi"
                            value="<?php echo e($enseignant->npi); ?>" id="basiInput">
                        <?php $__errorArgs = ['npi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" name="ifu"
                            value="<?php echo e($enseignant->ifu); ?>" id="basiInput">
                        <?php $__errorArgs = ['ifu'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <select name="banque_id" class="form-control" value="<?php echo e($enseignant->banque->nom); ?>"
                            id="basiInput" <?php $__errorArgs = ['banque_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            <?php $__currentLoopData = $banques; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banque): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option <?php echo e($enseignant->banque->nom == $banque->id ? 'selected' : ''); ?>

                                    value="<?php echo e($banque->id); ?>"><?php echo e($banque->nom); ?></option>
...
unset($__errorArgs, $__bag); ?>" name="compte"
                            value="<?php echo e($enseignant->compte); ?>" id="basiInput">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alexiskatel/Documents/UML Avancé/econtrat/resources/views/enseignants/edit.blade.php ENDPATH**/ ?>