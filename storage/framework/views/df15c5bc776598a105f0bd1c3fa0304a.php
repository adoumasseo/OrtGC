...
unset($__errorArgs, $__bag); ?>" name="nom"
                        value="<?php echo e($enseignant->nom); ?>" id="basiInput" readonly>
                    <?php $__errorArgs = ['nom'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" name="prenoms"
                        value="<?php echo e($enseignant->prenoms); ?>" id="basiInput" readonly>
...
unset($__errorArgs, $__bag); ?>" name="email"
                        value="<?php echo e($enseignant->email); ?>" id="basiInput" readonly>
...
unset($__errorArgs, $__bag); ?>" name="telephone"
                        value="<?php echo e($enseignant->telephone); ?>" id="basiInput" readonly>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3 col-md-6">
                    ...
                    <input type="text" class="form-control <?php $__errorArgs = ['sexe'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="sexe"
                    value="<?php echo e($enseignant->sexe); ?>" id="basiInput" readonly>
...
unset($__errorArgs, $__bag); ?>"
                        name="profession" value="<?php echo e($enseignant->profession); ?>" id="basiInput" readonly>
...
unset($__errorArgs, $__bag); ?>" name="adresse"
                        value="<?php echo e($enseignant->adresse); ?>" id="basiInput" readonly>
...
unset($__errorArgs, $__bag); ?>"
                        name="nationalite" value="<?php echo e($enseignant->nationalite); ?>" id="basiInput" readonly>
...
unset($__errorArgs, $__bag); ?>"
                        name="date_naissance" value="<?php echo e($enseignant->date_naissance); ?>" id="basiInput" readonly>
...
unset($__errorArgs, $__bag); ?>" name="npi"
                        value="<?php echo e($enseignant->npi); ?>" id="basiInput" readonly>
                    <?php $__errorArgs = ['npi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" name="ifu"
                        value="<?php echo e($enseignant->ifu); ?>" id="basiInput" readonly>
                    <?php $__errorArgs = ['ifu'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3 col-md-6">
                    ...
                    <input type="text" class="form-control <?php $__errorArgs = ['banque_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="banque_id"
                        value="<?php echo e($enseignant->banque->nom); ?>" id="basiInput" readonly>
...
unset($__errorArgs, $__bag); ?>" name="compte"
                        value="<?php echo e($enseignant->compte); ?>" id="basiInput" readonly>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="px-2 py-3 mt-3 bg-light d-flex justify-content-between">
                    <a href="<?php echo e(route('enseignants.index')); ?>" type="button"
                     ...
                     <a href="<?php echo e(route('enseignants.edit', ['enseignant' => $enseignant->slug])); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alexiskatel/Documents/UML Avancé/econtrat/resources/views/enseignants/show.blade.php ENDPATH**/ ?>