                            ...
                            <?php $__currentLoopData = $universites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $universite): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <optgroup label="<?php echo e($universite->nom); ?>">
                                    <?php $__currentLoopData = $universite->ufrs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ufr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($ufr->id); ?>">
                                            <span>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class=" mb-3 col-md-6">
                        ...
                        <input type="text" placeholder="" class="form-control <?php $__errorArgs = ['nom'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class=" mb-3  col-md-6">
                        ...
                        <input type="text" placeholder="" class="form-control <?php $__errorArgs = ['prenom'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                               name="prenom"
                               value="<?php echo e(old('prenom')); ?>" id="basiInput">
...
unset($__errorArgs, $__bag); ?>"
                               name="password"
                               value="<?php echo e(old('password')); ?>" id="basiInput">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6 mb-3 ">
                        ...
                        <select required name="sexe" class="form-control" value="<?php echo e(old('sexe')); ?>" id="basiInput"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\Documents\econtrat\resources\views/users/create.blade.php ENDPATH**/ ?>