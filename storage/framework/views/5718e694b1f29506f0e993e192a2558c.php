...
unset($__errorArgs, $__bag); ?>" name="code"
                        value="<?php echo e($ufr->code); ?>" id="basiInput">
...
unset($__errorArgs, $__bag); ?>" name="nom"
                        value="<?php echo e($ufr->nom); ?>" id="nomInput">
                    <?php $__errorArgs = ['nom'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" name="adresse"
                        value="<?php echo e($ufr->adresse); ?>" id="adresseInput">
...
unset($__errorArgs, $__bag); ?>" name="siteweb"
                        value="<?php echo e($ufr->siteweb); ?>" id="siteInput">
...
unset($__errorArgs, $__bag); ?>" name="email"
                        value="<?php echo e($ufr->email); ?>" id="emailInput">
...
unset($__errorArgs, $__bag); ?>" name="directeur"
                        value="<?php echo e($ufr->directeur); ?>" id="directeurInput">
...
unset($__errorArgs, $__bag); ?>" name="ville"
                        value="<?php echo e($ufr->ville); ?>" id="villeInput">
...
unset($__errorArgs, $__bag); ?>" name="logo"
                        value="<?php echo e($ufr->logo); ?>" id="logoInput">
...
unset($__errorArgs, $__bag); ?>" name="telephone"
                        value="<?php echo e($ufr->telephone); ?>" id="telInput">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="px-2 py-3 mt-3 bg-light d-flex justify-content-between">
                ...
                <a href="<?php echo e(route('ufrs.edit', ['ufr' => $ufr->slug])); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/herve/Documents/econtrat/resources/views/ufrs/show.blade.php ENDPATH**/ ?>