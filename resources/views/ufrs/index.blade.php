                            ...
                            <tbody>
                                @foreach ($ufrs as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->universite->nom }}</td>
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('ufrs.show', ['ufr' => $item->slug]) }}"
...
@section('script')
    ...
    <script src="{{ URL::asset('assets/js/pages/customs/ufr.js') }}"></script>
