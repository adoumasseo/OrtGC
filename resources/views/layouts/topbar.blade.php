            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="{{ URL::asset('images/logo-mesrs.png') }}" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="{{ URL::asset('images/logo-mesrs.png') }}" alt="" height="17">
                        </span>
                    </a>
                ...
                <form class="app-search d-none d-md-block">
                    <div class="mt-2">
                        <h4> {{ Auth::user()->ufr ? Auth::user()->ufr->nom : 'Administration e-contrat' }} </h4>
                    </div>
                    ...
                    <button type="button" class="btn shadow-none" id="page-header-user-dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            <img class="rounded-circle header-profile-user"
                                 src="@if (Auth::user()->avatar != ''){{ URL::asset('images/' . Auth::user()->avatar) }}@else{{ "https://ui-avatars.com/api/?name={$nom_complet}&background=random"}}@endif"
                                 alt="Header Avatar">
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text">{{$nom_complet}}</span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
