                        ...
                        <tbody>
                            @foreach ($filieres as $item)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a href="{{ route('filieres.show', ['filiere' => $item->slug]) }}"
                                            ...
                                            @if (Auth::user()->hasRole('Concepteur') or Auth::user()->hasRole('Administrateur'))
                                                <a href="{{ route('filieres.edit', ['filiere' => $item->slug]) }}"
                                                    type="button" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                    title="Editer"
                                                ...
                                                <button type="button" data-filiere="{{ $item->id }}"
...
<script src="{{ URL::asset('assets/js/pages/customs/filiere.js') }}"></script>
