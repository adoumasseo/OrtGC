                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="live-preview">
                                            <div class="d-flex flex-wrap gap-2">
                                                <button type="button" class="btn btn-outline-primary waves-effect waves-light shadow-none">Primary</button>
                                                <button type="button" class="btn btn-outline-secondary waves-effect waves-light shadow-none">Secondary</button>
                                                <button type="button" class="btn btn-outline-success waves-effect waves-light shadow-none">Success</button>
                                                <button type="button" class="btn btn-outline-info waves-effect waves-light shadow-none">Info</button>
                                                <button type="button" class="btn btn-outline-warning waves-effect waves-light shadow-none">Warning</button>
                                                <button type="button" class="btn btn-outline-danger waves-effect waves-light shadow-none">Danger</button>
                                                <button type="button" class="btn btn-outline-dark waves-effect waves-light shadow-none">Dark</button>
                                                <button type="button" class="btn btn-outline-light waves-effect shadow-none">Light</button>
                                            </div>
                                        </div>
                                        <div class="d-none code-view">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p class="text-muted">Use <code>btn-soft-</code>  class with the below-mentioned variation to create a button with the soft background.</p>                                        <div class="live-preview">
                                    	<div class="live-preview">
                                            <div class="d-flex flex-wrap gap-2">
                                                <button type="button" class="btn btn-soft-primary waves-effect waves-light shadow-none">Primary</button>
                                                <button type="button" class="btn btn-soft-secondary waves-effect waves-light shadow-none">Secondary</button>
                                                <button type="button" class="btn btn-soft-success waves-effect waves-light shadow-none">Success</button>
                                                <button type="button" class="btn btn-soft-info waves-effect waves-light shadow-none">Info</button>
                                                <button type="button" class="btn btn-soft-warning waves-effect waves-light shadow-none">Warning</button>
                                                <button type="button" class="btn btn-soft-danger waves-effect waves-light shadow-none">Danger</button>
                                                <button type="button" class="btn btn-soft-dark waves-effect waves-light shadow-none">Dark</button>
                                            </div>
                                        </div>
                                        <div class="d-none code-view">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="live-preview">
                                            <div class="d-flex flex-wrap gap-2">
                                                <button type="button" class="btn btn-ghost-primary waves-effect waves-light shadow-none">Primary</button>
                                                <button type="button" class="btn btn-ghost-secondary waves-effect waves-light shadow-none">Secondary</button>
                                                <button type="button" class="btn btn-ghost-success waves-effect waves-light shadow-none">Success</button>
                                                <button type="button" class="btn btn-ghost-info waves-effect waves-light shadow-none">Info</button>
                                                <button type="button" class="btn btn-ghost-warning waves-effect waves-light shadow-none">Warning</button>
                                                <button type="button" class="btn btn-ghost-danger waves-effect waves-light shadow-none">Danger</button>
                                                <button type="button" class="btn btn-ghost-dark waves-effect waves-light shadow-none">Dark</button>
                                            </div>
                                        </div>
                                        <div class="d-none code-view">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="d-flex flex-wrap gap-2 mb-3 mb-lg-0">
                                                        <a href="javascript:void(0);" class="btn btn-primary btn-label waves-effect waves-light">
                                                            <div class="d-flex">
                                                                <div class="flex-shrink-0">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="d-flex flex-wrap gap-2 mb-3 mb-lg-0">
                                                        <button type="button" class="btn btn-primary btn-label rounded-pill waves-effect waves-light"><i class="ri-user-smile-line label-icon align-middle rounded-pill fs-16 me-2"></i> Primary</button>
                                                        <button type="button" class="btn btn-success btn-label rounded-pill waves-effect waves-light"><i class="ri-check-double-line label-icon align-middle rounded-pill fs-16 me-2"></i> Success</button>
                                                        <button type="button" class="btn btn-warning btn-label rounded-pill waves-effect waves-light"><i class="ri-error-warning-line label-icon align-middle rounded-pill fs-16 me-2 "></i> Warning</button>
                                                    </div>
                                                </div><!--end col-->
                                                <div class="col-lg-4">
                                                    <div class="d-flex flex-wrap gap-2">
                                                        <button type="button" class="btn btn-primary btn-label waves-effect waves-light right"><i class="ri-user-smile-line label-icon align-middle fs-16 ms-2"></i> Primary</button>
                                                        <button type="button" class="btn btn-success btn-label waves-effect waves-light right rounded-pill"><i class="ri-check-double-line label-icon align-middle rounded-pill fs-16 ms-2"></i> Success</button>
                                                    </div>
                                                </div><!--end col-->
                                            </div><!--end row-->
                                        </div>
                                        ...
                                        <div class="live-preview">
                                            <div class="d-flex flex-wrap align-items-center gap-2">
                                               <!-- Large Button -->
                                                ...
                                                <button type="button" class="btn btn-light btn-lg waves-effect">Large button</button>

                                                <!-- Small Button -->
                                                <button type="button" class="btn btn-primary btn-sm waves-effect waves-light">Small button</button>
                                                <button type="button" class="btn btn-light btn-sm waves-effect">Small button</button>
                                            </div>
                                        </div>
                                        <div class="d-none code-view">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="live-preview">
                                            <div class="d-flex flex-wrap gap-2">
                                                ...
                                                <input class="btn btn-info waves-effect waves-light" type="button" value="Input">
                                        ...
                                        <div class="live-preview">
                                            <div class="d-flex flex-wrap align-items-center gap-2">
                                                <div class="btn-group shadow" role="group" aria-label="Basic checkbox toggle button group">
                                                    ...
                                                    <label class="btn btn-primary shadow-none mb-0" for="btncheck1">Checkbox 1</label>

                                                    <input type="checkbox" class="btn-check" id="btncheck2">
                                                    <label class="btn btn-primary shadow-none mb-0" for="btncheck2">Checkbox 2</label>

                                                    <input type="checkbox" class="btn-check" id="btncheck3">
                                                    <label class="btn btn-primary shadow-none mb-0" for="btncheck3">Checkbox 3</label>
                                                </div>

                                                <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                                                    <input type="radio" class="btn-check" name="btnradio" id="btnradio1" checked="">
                                                    <label class="btn btn-outline-secondary shadow-none mb-0" for="btnradio1">Radio 1</label>

                                                    <input type="radio" class="btn-check" name="btnradio" id="btnradio2">
                                                    <label class="btn btn-outline-secondary shadow-none mb-0" for="btnradio2">Radio 2</label>

                                                    <input type="radio" class="btn-check" name="btnradio" id="btnradio3">
                                                    <label class="btn btn-outline-secondary shadow-none mb-0" for="btnradio3">Radio 3</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="d-none code-view">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="live-preview">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="btn-group shadow mt-4 mt-sm-0" role="group" aria-label="Basic example">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="hstack gap-2 mt-4 mt-sm-0">
                                                        <button type="button" class="btn btn-outline-primary btn-icon waves-effect waves-light shadow-none"><i class="ri-24-hours-fill"></i></button>
                                                        <button type="button" class="btn btn-outline-danger btn-icon waves-effect waves-light shadow-none"><i class="ri-customer-service-2-line"></i></button>
                                                        <button type="button" class="btn btn-outline-success btn-icon waves-effect waves-light shadow-none"><i class="ri-mail-send-line"></i></button>
                                                        <button type="button" class="btn btn-outline-warning btn-icon waves-effect waves-light shadow-none"><i class="ri-menu-2-line"></i></button>
                                                    </div>
                                                </div><!--end col-->
                                            </div><!--end row-->
                                        </div>
                                            ...
                                            <div class="d-flex flex-wrap gap-3">
                                                <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                                                    <div class="btn-group shadow me-2" role="group" aria-label="First group">
                                                        <button type="button" class="btn btn-light waves-effect shadow-none">1</button>
                                                        <button type="button" class="btn btn-light waves-effect shadow-none">2</button>
                                                        <button type="button" class="btn btn-light waves-effect shadow-none">3</button>
                                                        <button type="button" class="btn btn-light waves-effect shadow-none">4</button>
                                                    </div>
                                                    <div class="btn-group shadow me-2" role="group" aria-label="Second group">
                                                        <button type="button" class="btn btn-light waves-effect shadow-none">5</button>
                                                        <button type="button" class="btn btn-light waves-effect shadow-none">6</button>
                                                        <button type="button" class="btn btn-light waves-effect shadow-none">7</button>
                                                    </div>
                                                    <div class="btn-group shadow" role="group" aria-label="Third group">
                                                        <button type="button" class="btn btn-light waves-effect shadow-none">8</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-auto">
                                                    <div class="btn-group shadow" role="group" aria-label="Button group with nested dropdown">
                                                        <button type="button" class="btn btn-primary waves-effect waves-light shadow-none">1</button>
                                                        <button type="button" class="btn btn-primary waves-effect waves-light shadow-none">2</button>
                                                        <div class="btn-group" role="group">
                                                            <button id="btnGroupDrop1" type="button" class="btn btn-primary waves-effect waves-light shadow-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                                                Dropdown
                                                            </button>
                                                ...
                                                <div class="col-auto">
                                                    <div class="btn-group-vertical shadow" role="group" aria-label="Vertical button group">
                                                        <button type="button" class="btn btn-light waves-effect shadow-none">Button</button>
                                                        <div class="btn-group" role="group">
                                                            <button id="btnGroupVerticalDrop1" type="button" class="btn btn-light waves-effect shadow-none dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                Dropdown
                                                            </button>
                                                ...
                                                <div class="col-auto">
                                                    <div class="btn-group-vertical" role="group" aria-label="Vertical radio toggle button group">
                                                        ...
                                                        <label class="btn btn-outline-secondary waves-effect waves-light shadow-none" for="vbtn-radio1">Radio 1</label>
                                                        <input type="radio" class="btn-check" name="vbtn" id="vbtn-radio2">
                                                        <label class="btn btn-outline-secondary waves-effect waves-light shadow-none" for="vbtn-radio2">Radio 2</label>
                                                        <input type="radio" class="btn-check" name="vbtn" id="vbtn-radio3">
                                                        <label class="btn btn-outline-secondary waves-effect waves-light shadow-none" for="vbtn-radio3">Radio 3</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="live-preview">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <p class="mb-lg-0"><a href="#!" class="d-inline-flex focus-ring focus-ring-danger py-1 px-2 text-decoration-none border rounded-2">Danger focus</a></p>
                                            </div><!--end col-->
                                            <div class="col-lg-6">
